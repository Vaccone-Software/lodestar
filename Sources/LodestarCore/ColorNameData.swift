// Generated by tools/color-names/curate.py from the xkcd color survey
// (https://xkcd.com/color/rgb.txt, CC0). Edit the script, not this file.

extension ColorNames {
    /// 812 names, one per line: the name, a tab, the color as RRGGBB.
    static let table = """
Cloudy Blue	ACC2D9
