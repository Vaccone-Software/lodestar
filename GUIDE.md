...
The far end can be anywhere you can see, **including lines below the one you started on** and text in a window beside it. The span then runs the way reading does: the rest of the line you anchored in, everything between it and the far end, and the far end's line up to the word you picked — every piece of it highlighted, so what lights up is exactly what `⌘C` gives you.
